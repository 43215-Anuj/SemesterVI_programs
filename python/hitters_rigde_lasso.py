...
"""
Created on Mon Feb 10 21:47:19 2020
...
df = pd.read_csv("D://Project Work//Study Material//SemesterVI_programs//python//Hitters.csv")
df.info()
...
#fill all nan values with mean of the data
y = y.fillna(np.mean(df.Salary))
...
# error is 0.008737642000038414. What is the test MSE associated with this value of
# alpha?
